  ...
  return (
    <Layout>
      <section
        ...
        <div className="flex w-full flex-col items-center justify-center gap-5 py-10 md:flex-row">
          <select class="select select-secondary w-full max-w-xs bg-secondary/10 font-semibold text-secondary">
            <option disabled selected>
              Number of bedrooms
            </option>
            {new Array(10).fill("").map((_, i) => (
              <option>{i + 1} Bedroom</option>
            ))}
          </select>
        ...
        <div className="relative rounded-xl border-[3px] border-success bg-transparent shadow-lg md:my-5">
          <a className="btn glass btn-warning text-wrap text-secondary md:btn-md lg:btn-lg" href="/estimate">
            ...
            Schedule it! - <span className="text-xl font-bold text-accent">$240.64</span>
